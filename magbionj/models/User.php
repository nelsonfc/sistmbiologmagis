...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['estado', 'rol'], 'integer'],
            [['nombre', 'username', 'nombre_rol'], 'string'],
            [['username'], 'unique'],
            ['email', 'email'],
            [['password', 'password2'], 'string', 'min' => 8],
            ['password', 'validatepass', 'skipOnEmpty' => false, 'skipOnError' => false],
            ['password2', 'validatepass2', 'skipOnEmpty' => false, 'skipOnError' => false],
        ];
    }
    ...
    public function validatepass2($attribute, $params) {
